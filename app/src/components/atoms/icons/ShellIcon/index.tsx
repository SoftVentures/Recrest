...
import CmdLogo from "@/components/atoms/icons/ShellIcon/logos/cmd.svg?react";
import PowershellCoreLogo from "@/components/atoms/icons/ShellIcon/logos/powershell-core.svg?react";
import WindowsPowershellLogo from "@/components/atoms/icons/ShellIcon/logos/windows-powershell.svg?react";
import WslLogo from "@/components/atoms/icons/ShellIcon/logos/wsl.svg?react";

/**
 * Brand marks for every shell Recrest knows about. Same shape as
 * `GeneralTerminalIcon`: vendored `.svg?react` for Microsoft / WSL marks
...
function GeneralShellIcon({ id, size = 16, color = "brand", title, style }: ShellIconProps) {
...
export default GeneralShellIcon;
