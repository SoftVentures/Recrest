...
const PATHS: Record<IconName, ReactElement> = {
  ...
  license: (
    <>
      <path d="M15 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v5" />
      <polyline points="15 3 15 8 20 8" />
      <circle cx="17.5" cy="17.5" r="3" />
      <path d="m16 20.5-1.5 2.5 3-1.5 3 1.5-1.5-2.5" />
    </>
  ),
  /** GitHub-style repo glyph: hardcover book with a ribbon bookmark. */
  repo: (
    <>
      <path d="M4 4.5A2.5 2.5 0 0 1 6.5 2H20v16H6.5a1.5 1.5 0 0 0 0 3H20v1H6.5A2.5 2.5 0 0 1 4 19.5z" />
      <path d="M10 2v9l3-2 3 2V2" />
    </>
  ),
  ...
  scale: (
    <>
      ...
      <path d="M5 21h14" />
      <path d="M6 7h12" />
      <path d="m7 7-4 8a4 4 0 0 0 8 0L7 7z" />
      <path d="m17 7-4 8a4 4 0 0 0 8 0l-4-8z" />
    </>
  ),
};
