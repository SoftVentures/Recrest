...
import { AboutTabBody } from "@/components/settings/AboutTab";
...
import { SystemSettings } from "@/components/settings/GeneralSettings";
...
const TABS: { id: TabId; icon: IconName; labelKey: string }[] = [
  ...
  { id: "accounts", icon: "github", labelKey: "settings.tab.accounts" },
