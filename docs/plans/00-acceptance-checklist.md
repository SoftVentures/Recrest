...
- [ ] **1.A4** — Repo mit Commits unter "Müller <ü@x>" und "Mueller <ue@x>" → Leaderboard zeigt **eine** Zeile. Test-Repo mit französischen/polnischen/türkischen Diakritika ebenfalls korrekt vereint. Manuelles Override über `authorAliases` möglich. (→ Plan 1 §A.4)
